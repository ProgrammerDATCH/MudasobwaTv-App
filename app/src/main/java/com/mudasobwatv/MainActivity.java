    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkRun = new Runnable() {
            ...
            public void run() {
                ...
                {
                    Toast.makeText(MainActivity.this, "No internet Connection to load UNGUKA Mudasobwa Tv Server!", Toast.LENGTH_LONG).show();
                    checkConn.postDelayed(checkRun, 10000);
                }
                else
                {
                    Toast.makeText(MainActivity.this, "Connected to Mudasobwa Tv Server", Toast.LENGTH_SHORT).show();
                    //good
